...
Background:
    Given the following products
        ...
        | Shoes      | New Balance sneakers| 120.00  | False     | CLOTHS     |
        | Big Mac    | 1/4 lb burger       | 5.99    | True      | FOOD       |
        | Sheets     | King sized sheets   | 87.00   | True      | HOUSEWARES |
        | Drill      | Power drill         | 45.00   | True      | TOOLS      |
...
Scenario: Update a Product
    ...
    Then I should see the message "Success"
    And I should see "Hat" in the "Name" field
    When I set the "Description" to "Updated fedora description"
    And I press the "Update" button
    Then I should see the message "Success"
    When I press the "Clear" button
    And I paste the "Id" field
    And I press the "Retrieve" button
    Then I should see "Updated fedora description" in the "Description" field

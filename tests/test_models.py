...
class TestProductModel(unittest.TestCase):
    ...
    def test_delete_a_product(self):
        ...
        # Delete it and make sure it isn't in the database
        product.delete()
        self.assertEqual(len(Product.all()), 0)

    # ------------------------------------------------------------------
    # T A S K  2 :  L I S T   A L L
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # T A S K  2 :  F I N D   B Y   C A T E G O R Y
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # T A S K  2 :  F I N D   B Y   A V A I L A B I L I T Y
    # ------------------------------------------------------------------
    ...
    def test_deserialize_missing_data(self):
        ...
        data = {"id": 1, "name": "Fedora", "price": "2.00"}
        product = Product()
